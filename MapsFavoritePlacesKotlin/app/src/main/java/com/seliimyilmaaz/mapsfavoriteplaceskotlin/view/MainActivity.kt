...
import com.seliimyilmaaz.mapsfavoriteplaceskotlin.adepter.PlaceAdepter
import com.seliimyilmaaz.mapsfavoriteplaceskotlin.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleResponse(listOfPlaces:List<Place>){
        binding.recyclerView.adapter = PlaceAdepter(listOfPlaces)
